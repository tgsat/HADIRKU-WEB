class AppIcons {
  AppIcons._();
  //// For custom web app icons it won't work if you use an icon pack such as ionicons and iconsax, you can use a method like this or use a ttf format file. Happy Coding :)
